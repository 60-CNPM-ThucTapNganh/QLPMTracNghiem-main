...
<?php
if (isset($_SESSION['mh']['tenMH'])) {
    $tenMH = $_SESSION['mh']['tenMH'];
...
<div class="checkform">
    <div class="content">
        ...
        <form action="MonHoc/Save/<?php echo $data['mh']['MaMH'] ?>" method="POST" enctype="multipart/form-data">
            <div class="form-horizontal">
                <hr />
                <div class="form-group1">
                    <label for="mamh" class="control-label col-md-4"><b>Mã môn học</b></label>
                    <div class="col-md-8">
                        <input type="text" class="form-control text-box single-line" id="mamh" name="mamh" readonly value="<?php echo $data['mh']['MaMH']; ?>">
                    </div>
                </div>

                <div class="form-group1">
                    <label for="tenmh" class="control-label col-md-4"><b>Tên môn học</b></label>
                    <div class="col-md-8">
                        <input type="text" class="form-control text-box single-line" id="tenmh" name="tenmh" value="<?php echo $tenMH; ?>">
