...
<div class="checkform">
    <div class="content">
        <h3 style="margin-left: 15px;">Bạn chắc chắn muốn xóa chi tiết kỳ thi này ?</h3>
        <form action="ChiTietKyThi/Confirm/<?php echo $data['ctkt']['MaKT'] ?>/<?php echo $data['ctkt']['MaCH'] ?>" method="post">
            <div class="form-horizontal" style="display:flex; margin-left: 15px; justify-content: center;">
                <div  style="width: 350px;">
                    <label class="form-control">Tên kỳ thi: <?php echo $data['ctkt']['TenKT'] ?> </label>
                    <label class="form-control">Tên câu hỏi: <?php echo $data['ctkt']['NoiDung'] ?> </label>
                </div>
            </div>
