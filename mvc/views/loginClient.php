        ...
        <div class="bg-white max-w-lg mx-auto p-8 md:p-12 lg:w-1/2 my-10 rounded shadow-2xl">
            ...
            <form action="loginClient/loginClient" method="POST" class="space-y-5">
                ...
                <div>
                    ...
                    <input type="text" placeholder="Nhập email sinh viên..." name="email" class="w-full border-2 border-gray-200 p-3 rounded outline-none focus:border-purple-500" value="<?php if (isset($_SESSION['loginClient']['Email'])) echo $_SESSION['loginClient']['Email'];
                ...
                <div class="form-group">
                    ...
                    <input type="password" placeholder="Mật khẩu" name="password" class="w-full border-2 border-gray-200 p-3 rounded outline-none focus:border-purple-500">
                    <span class="text-red-500"><?php if (isset($_SESSION['error']['Password'])) {
                        echo $_SESSION['error']['Password'];
                        unset($_SESSION['error']['Password']);
                        } ?></span>
                </div>
                <button type="submit" name="submit" class="font-bold block w-full bg-purple-600 hover:bg-purple-700 p-4 rounded text-white transition duration-300">Đăng nhập</button>
            </form>
        </div>
    </div>
</body>
