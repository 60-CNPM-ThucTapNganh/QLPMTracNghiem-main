            ...
            <tbody class="divide-y divide-gray-200">
                ...
                ?>
                    <tr>
                        ...
                        <td class="px-6 py-4 text-center"> <?php echo $item["SoCauDung"]; ?> </td>
                        <td class="px-6 py-4 text-center"> <?php echo $item["DiemSo"]; ?> </td>
                        <?php
                            echo "<td class='px-6 py-4 text-center'><a href='LichSuBaiLam/Index/" . $item["MaKT"] . "' class='text-purple-800 hover:underline'>Xem lại</a></td>";
                        ?>
                    </tr>
            </tbody>
        <?php
